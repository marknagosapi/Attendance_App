...
type ClassDetailScreenRouteProp = RouteProp<ProfessorRootStackParamList, 'ClassDetailScreen'>;
type ClassDetailScreenNavigationProp = NativeStackNavigationProp<ProfessorRootStackParamList, 'ClassDetailScreen'>;
